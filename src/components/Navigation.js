        ...
        <nav className="relative flex flex-col sm:flex-row sm:justify-between mt-4 bg-gray-700 text-xl">
                ...
                <div id="menu-list" className="hidden sm:block bg-gray-700 absolute top-16 w-full sm:relative sm:w-auto sm:top-0">
                    <ul id="menu-items" className="w-full sm:w-auto h-full flex sm:relative sm:top-0 flex-col sm:flex-row items-stretch justify-center font-semibold">
                        <li className="border-b border-gray-500 sm:border-0 p-3 px-6 card-link"><a class="inline-block h-full w-full" href="#about">About</a></li>
                        <li className="border-b border-gray-500 sm:border-0  p-3 px-6 card-link"><a class="inline-block h-full w-full"  href="#projects">Projects</a></li>
                        <li className="border-b border-gray-500 sm:border-0  p-3 px-6 card-link"><a class="inline-block h-full w-full"  href="#connect">Connect</a></li>
                    </ul>
                </div>
